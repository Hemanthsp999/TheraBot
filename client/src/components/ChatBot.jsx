  ...
  return (
    <div className="flex flex-col h-[calc(100vh-4rem)] bg-gray-100 rounded-2xl">
      ...
      <div className="bg-white border-b rounded-xl p-4 shadow-sm flex items-center justify-between">
        <button
          onClick={handleBack}
          className="text-gray-100 hover:text-gray-300 p-1 rounded-lg hover:bg-gray-100"
        >
          <ArrowLeft size={24} />
        </button>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.map((message, index) => (
          ...
          >
            <div
              className={`max-w-[70%] p-3 bg-white rounded-2xl  ${
                message.type === "user"
      ...
      <form onSubmit={handleSendMessage} className="border-t p-4">
        <div className="flex gap-2 bg-white">
          ...
          <button
            ...
            className="p-2 bg-gray-200 hover:bg-gray-300 rounded-lg text-white"
          >
            <Mic size={20} />
          </button>
