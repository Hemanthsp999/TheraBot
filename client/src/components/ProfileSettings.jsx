        ...
        <div className="w-full md:w-1/3 bg-blue-600 text-white p-6 rounded-l-lg flex flex-col items-center">
          <div className="bg-white text-blue-600 p-3 rounded-full mb-4">
            <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 14l6.16-3.422M6 9.578L12 14" />
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 14V21" />
            </svg>
          </div>
          <h2 className="text-lg font-semibold">Welcome, {therapist.name}</h2>

          <nav className="mt-6 space-y-3 text-center">
            <p className="hover:underline cursor-pointer">Dashboard</p>
            <p className="hover:underline cursor-pointer">New Translation</p>
            <p className="hover:underline cursor-pointer">My Projects</p>
            <p className="hover:underline cursor-pointer">My Translations</p>
            <p className="hover:underline cursor-pointer">Billing & Payment</p>
            <p className="hover:underline cursor-pointer">Settings</p>
            <p className="hover:underline cursor-pointer text-red-400">Log Out</p>
          </nav>
        </div>

        {/* Main Content */}
        <div className="flex-1 p-6">
          <h2 className="text-2xl font-semibold text-gray-700 mb-5 text-center">Your Personal Profile Info</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Profile Section */}
            <div>
              <h3 className="text-lg font-semibold mb-3 bg-black">Profile</h3>
