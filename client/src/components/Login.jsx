const Login = () => {
    return(
        <>
            <div className="border-10 dark:border-black-400 text-wrap">
                <form className="max-w-md mx-auto mt-4 text-start">
                    ...
                    <p className="text-gray-900 py-2">Don't have an Account?<a href='#'> Register here</a></p>
                    </div>
